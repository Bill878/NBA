...
public class Player {
    ...
    public void setLevel() {
        ...
        if (creditValue >= 0 && creditValue < 1000) {
            this.level.set("Benchwarmer");
        } else if (creditValue >= 1000 && creditValue < 1800) {
            this.level.set("Role Player");
        } else if (creditValue >= 1800 && creditValue < 2400) {
            this.level.set("Starter");
        } else if (creditValue >= 2400 && creditValue < 2800) {
            this.level.set("All Star");
        } else if (creditValue >= 2800) {
            this.level.set("Superstar");
        }
    }
